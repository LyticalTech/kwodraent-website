			...
			<Container>
				...
				<div className='flex flex-col items-start gap-6'>
					...
					<div className='flex flex-col md:flex-row md:items-center md:justify-between gap-6 w-full'>
						<p className='text-white text-3xl max-w-4xl '>
                        We’ve been at the forefront of subsea for decades, because we put our customers first. Here are some of the ways we can help you.</p>

						<a
							href='#what-we-do'
							className='inline-flex'
						>
							<button className='flex items-center gap-2 bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition'>

			...
			<Container>
				<div className='max-w-6xl mx-auto'>
					...
					<div className='flex flex-col w-full items-start'>
						<h2 className=' text-[clamp(2.6rem,3.8vw,6rem)] font-mediu text-gray-800 leading-[1.1] tracking-tight'>
							Partnerships
						</h2>
						<p className='mt-4 max-w-5xl text-[clamp(1.05rem,1.4vw,1.3rem)] text-gray-800 leading-[1.6]'>
